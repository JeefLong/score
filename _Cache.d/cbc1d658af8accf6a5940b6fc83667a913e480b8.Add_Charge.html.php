...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5d04b0a3bc2a79_16430776',
  'cache_lifetime' => '3600',
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d04b0a3bc2a79_16430776')) {function content_5d04b0a3bc2a79_16430776($_smarty_tpl) {?><!DOCTYPE HTML>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="/Admin/Charge/AddCharge">代理充值</a>
                    </li>
                    ...
                    <div class="row col-xs-12 col-sm-12 col-lg-12">
                        <div class="table-responsive fadeInDown animated">
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                <tr> <th>代理对应的ID</th>    
                                    <td>
                                        <input type="text"  placeholder="代理的ID" id="agent_id" name="agent_id"  />
