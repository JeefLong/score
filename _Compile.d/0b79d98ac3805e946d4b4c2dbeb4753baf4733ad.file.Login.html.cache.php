<?php /* Smarty version Smarty-3.1.21-dev, created on 2019-09-24 23:39:50
         compiled from "F:\HTDOCS\Angent_game\Application\views\Admin\Login\Login.html" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5d8a38c6d9b4e5_36643041',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d8a38c6d9b4e5_36643041')) {function content_5d8a38c6d9b4e5_36643041($_smarty_tpl) {?><?php if (!is_callable('smarty_function_asource')) include 'F:\\HTDOCS\\Angent_game\\Application\\library\\Smarty\\plugins\\function.asource.php';
?><!DOCTYPE HTML>
                                ...
                                <fieldset>
                                    <label class="block clearfix">
                                        <span class="block input-icon">
                                            <input type="text" class="form-control" name="username" id="username" placeholder="请输入用户名" <?php if (isset($_smarty_tpl->tpl_vars['Uname']->value)) {?> value='<?php echo $_smarty_tpl->tpl_vars['Uname']->value;?>
' <?php }?> />
                                    ...
                                    <label class="block clearfix">
                                        <img src='/Admin/Login/Code' width=120 height=40 id="pic_yzm" />
