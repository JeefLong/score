<?php /* Smarty version Smarty-3.1.21-dev, created on 2019-06-15 16:47:31
         compiled from "F:\HTDOCS\Angent_game\Application\views\Admin\Charge\Add_Charge.html" */ ?>
<?php /*%%SmartyHeaderCode:19265494945d04b0a3af9784-78539504%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cbc1d658af8accf6a5940b6fc83667a913e480b8' => 
    array (
      0 => 'F:\\HTDOCS\\Angent_game\\Application\\views\\Admin\\Charge\\Add_Charge.html',
      1 => 1512380647,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19265494945d04b0a3af9784-78539504',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d04b0a3b1e979_86421977',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d04b0a3b1e979_86421977')) {function content_5d04b0a3b1e979_86421977($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("Admin/Public/header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, NULL, array(), 0);?>
...
" <?php }?> />
                                ...
                                <tr> <th>充值/提现数量</th>
                                    <td>
                                        <input type="text"  placeholder="正数充值;负数提现" id="charge_card" name="charge_card" /> 
                                        <b class="red">   * [代理提现] 当充值为负数时是扣除相应的房卡,直到数量为0; [代理充值] 当为正数时是增加相应的房卡  </b>
                                    </td>
                                </tr>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr> <th>房卡数量</th> <td><input type="number"  placeholder="房卡数量" id="agt_card" value="0" readonly />     </td>  </tr>
 ...
 type="text/javascript">
        $('#add_data').click(function () {
            ...
            $.ajax({
                type: 'POST',
                url: '/Admin/Charge/AjaxAddCharge',
                async: false,
                data: {'agent_id': agent_id, 'charge_card': charge_card, 'charge_desc': charge_desc},
                dataType: 'json',
